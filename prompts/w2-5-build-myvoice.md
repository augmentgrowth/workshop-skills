# W2 · Step 5 — Build Your MyVoice Skill

**Where:** the **same Claude Code session** as [Step 4 — extraction](w2-4-voice-extraction.md) — the build needs your corpus and review answers on the table. (If the session feels heavy, run `/compact` first, then continue.)
...
4. Continue to [Step 6 — Invoke it](w2-6-invoke-myvoice.md).
