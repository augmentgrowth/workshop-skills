...
**Where:** the **same Claude Code session** as [Step 3 — extraction](w2-voice-extraction.md) — the build needs your corpus and review answers on the table. (If the session feels heavy, run `/compact` first, then continue.)
...
4. Continue to [Step 5 — Invoke it](w2-invoke-myvoice.md).
